...
INTRODUCTION: We are analysing the returns on 30 DJIA stocks and plotting them on a n efficient frontier(risk vs return graph) so as to make the best portfolio decisions. 
